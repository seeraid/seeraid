...
var seeraidApp = angular.module('seeraidApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'seeraidAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
