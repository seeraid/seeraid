...
seeraidApp.controller('MainController', function ($scope) {
    });

seeraidApp.controller('AdminController', function ($scope) {
    });

seeraidApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
seeraidApp.controller('MenuController', function ($scope) {
    });

seeraidApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
seeraidApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

seeraidApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
seeraidApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
seeraidApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
seeraidApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
seeraidApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 seeraidApp.controller('TrackerController', function ($scope) {
...
seeraidApp.controller('HealthController', function ($scope, HealthCheckService) {
...
seeraidApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
    $scope.configuration = resolvedConfiguration;
});

seeraidApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
seeraidApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
seeraidApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
