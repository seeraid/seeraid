package org.seeraid.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import org.seeraid.web.filter.CachingHttpHeadersFilter;
import org.seeraid.web.filter.StaticResourcesProductionFilter;
import org.seeraid.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "org.seeraid.web.websocket");
