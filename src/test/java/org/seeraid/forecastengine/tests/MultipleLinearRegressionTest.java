...
import org.seeraid.forecastengine.models.MultipleLinearRegressionModel;
 ...
 */
public class MultipleLinearRegressionTest extends ForecastEngineBaseTestCase
{
    /**
    ...
    public void testForecaster()
    {
        ...
        assertTrue( forecaster
                    .getClass()
                    .getName()
                    .equals("org.seeraid.forecastengine.models.MultipleLinearRegressionModel") );
